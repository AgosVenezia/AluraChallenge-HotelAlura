...
public class Busqueda extends JFrame {
	...
	private void ActualizarReservas() {
		Optional<Object> filaReserva = Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()));
		if (filaReserva.isPresent()) {
		  filaReserva.ifPresent((Object fila) -> {
			if (fila != null) {
	...
	private void ActualizarHuesped() {
		Optional<Object> filaHuesped = Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()));
		if (filaHuesped.isPresent()) {
		  filaHuesped.ifPresent((Object fila) -> {
			if (fila != null) {
